...
```
/session/-Users-user-dev--myorg-mvp-app/974d98a2-2a04-49dc-b37e-db042a9d1345
```
...
```
/project/mvp-app/session/fix-login-bug-974d98a2
```

Structure: `/project/:projectSlug/session/:sessionSlug`

Where:
- `projectSlug` = `displayName` slugified (e.g., `mvp-app`)
...
- URL should be: `/project/-Users-user-dev--myorg-mvp-app/session/fix-the-login-bug-974d98a2`
- Breadcrumb should show: `mvp-app > fix the login bug`
...
URLs change from:
  /session/-Users-user-dev--myorg-mvp-app/974d98a2-...
to:
