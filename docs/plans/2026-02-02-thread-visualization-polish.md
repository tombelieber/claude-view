...
Run: `cd /Users/user/dev/@myorg/claude-view && npx vitest run src/lib/thread-map.test.ts`
...
Run: `cd /Users/user/dev/@myorg/claude-view && npx vitest run src/components/ConversationView.thread.test.ts`
...
Run: `cd /Users/user/dev/@myorg/claude-view && npx vitest run src/components/`
...
Run: `cd /Users/user/dev/@myorg/claude-view && npx vitest run src/contexts/ThreadHighlightContext.test.tsx`
...
Run: `cd /Users/user/dev/@myorg/claude-view && npx vitest run src/`
...
Run: `cd /Users/user/dev/@myorg/claude-view && npx vitest run src/components/MessageTyped.test.tsx`
