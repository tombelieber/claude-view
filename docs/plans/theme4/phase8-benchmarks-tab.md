...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/crates/server/src/routes/insights.rs` (or extend existing)

**Files to modify:**
- `/Users/user/dev/@myorg/claude-view/crates/core/src/types.rs`
- `/Users/user/dev/@myorg/claude-view/crates/db/src/queries.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/routes/mod.rs`
...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/src/components/insights/ThenVsNow.tsx`
- `/Users/user/dev/@myorg/claude-view/src/components/insights/ThenVsNow.test.tsx`
...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/src/components/insights/CategoryPerformanceTable.tsx`
- `/Users/user/dev/@myorg/claude-view/src/components/insights/CategoryPerformanceTable.test.tsx`
...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/src/components/insights/SkillAdoptionImpact.tsx`
- `/Users/user/dev/@myorg/claude-view/src/components/insights/SkillAdoptionImpact.test.tsx`
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>
          Generated by claude-view • {new Date().toLocaleDateString()}
        </Text>
      </Page>
    </Document>
  )
...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/src/components/insights/MonthlyReportGenerator.tsx`
- `/Users/user/dev/@myorg/claude-view/src/components/insights/reportPdfGenerator.tsx`
- `/Users/user/dev/@myorg/claude-view/src/components/insights/ReportPreviewModal.tsx`
- `/Users/user/dev/@myorg/claude-view/src/components/insights/MonthlyReportGenerator.test.tsx`

**Files to modify:**
- `/Users/user/dev/@myorg/claude-view/package.json` (add @react-pdf/renderer)
...
│                                         │
│  ─────────────────────────────────────  │
│  Generated by claude-view • 2026-02-05  │
└─────────────────────────────────────────┘
```
