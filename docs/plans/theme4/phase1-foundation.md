...
**Files to modify:**
- `/Users/user/dev/@myorg/claude-view/crates/db/src/migrations.rs`
...
- `/Users/user/dev/@myorg/claude-view/crates/core/src/types.rs`
- `/Users/user/dev/@myorg/claude-view/crates/db/src/queries.rs`
- `/Users/user/dev/@myorg/claude-view/crates/db/src/indexer_parallel.rs`
...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/crates/core/src/llm/mod.rs`
- `/Users/user/dev/@myorg/claude-view/crates/core/src/llm/provider.rs`
- `/Users/user/dev/@myorg/claude-view/crates/core/src/llm/types.rs`
- `/Users/user/dev/@myorg/claude-view/crates/core/src/llm/claude_cli.rs`

**Files to modify:**
- `/Users/user/dev/@myorg/claude-view/crates/core/src/lib.rs`
- `/Users/user/dev/@myorg/claude-view/crates/core/Cargo.toml`
...
**Files to create:**
- `/Users/user/dev/@myorg/claude-view/crates/server/src/jobs/mod.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/jobs/types.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/jobs/state.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/jobs/runner.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/routes/jobs.rs`

**Files to modify:**
- `/Users/user/dev/@myorg/claude-view/crates/server/src/lib.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/state.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/routes/mod.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/src/main.rs`
- `/Users/user/dev/@myorg/claude-view/crates/server/Cargo.toml`
