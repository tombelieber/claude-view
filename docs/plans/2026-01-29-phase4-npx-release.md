...
| GitHub repo (`OWNER/claude-view`) | Exists | — |
...
1. Go to `https://github.com/OWNER/claude-view/settings/secrets/actions`
...
- `https://github.com/OWNER/claude-view` is public
...
Confirm `NPM_TOKEN` exists at `https://github.com/OWNER/claude-view/settings/secrets/actions`
...
**Step 5: Monitor CI** at `https://github.com/OWNER/claude-view/actions`
