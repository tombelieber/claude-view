...
- `/Users/user/dev/@myorg/claude-view` → `-Users-user-dev--myorg-claude-view`
...
```
Encoded: -Users-user-dev--myorg-claude-view
Decoded: /Users/user/dev/@myorg/claude-view
Verify:  fs.existsSync('/Users/user/dev/@myorg/claude-view') → true
