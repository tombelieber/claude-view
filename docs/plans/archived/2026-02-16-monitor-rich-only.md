...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/mission-control-cde && bunx vitest run src/store/monitor-store.test.ts`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/mission-control-cde && bunx vitest run src/components/live/GridControls.test.tsx`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/mission-control-cde && bunx vitest run src/components/live/`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/mission-control-cde && cargo test -p vibe-recall-server -- routes::terminal`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/mission-control-cde && bunx vitest run`
