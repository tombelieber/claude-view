...
```bash
cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && bun test -- use-dashboard StatsDashboard --no-coverage 2>&1
```
...
In another terminal:
```bash
cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && bun run dev
```
