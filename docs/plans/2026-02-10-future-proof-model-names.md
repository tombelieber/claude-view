...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && bun test src/components/AIGenerationStats.test.tsx`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && bun test src/components/FilterPopover.test.tsx`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && bun run preview`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && cargo test -p vibe-recall-server -- routes::sessions`
...
Run: `cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics && bun test src/components/contributions/`
...
```bash
cd /Users/TBGor/dev/@vicky-ai/claude-view/.worktrees/dashboard-analytics
bun test
