...
1. Go to **https://github.com/vicky-ai/claude-view/settings/secrets/actions**
   - Replace `vicky-ai` with your GitHub username if needed
...
Go to **https://github.com/vicky-ai/claude-view/settings** and check:
...
Go to **https://github.com/vicky-ai/claude-view/settings/secrets/actions** and confirm you see:
...
Go to **https://github.com/vicky-ai/claude-view/actions** and watch the release workflow.
...
Add to **https://github.com/vicky-ai/claude-view/releases/tag/v0.2.0**:
...
### Feedback
Found a bug? Have a feature request? [Open an issue](https://github.com/vicky-ai/claude-view/issues)
```
...
>
> GitHub: [vicky-ai/claude-view](https://github.com/vicky-ai/claude-view)
...
- **Fix:** Go to https://github.com/vicky-ai/claude-view/settings/secrets/actions and verify `NPM_TOKEN` is set
...
- **Check:** https://github.com/vicky-ai/claude-view/actions
