    ...
    <div className="rounded border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
      ...
      <div className="border-b border-gray-200/30 dark:border-gray-700/30">
        <button
          ...
          className="flex items-center gap-1 w-full px-2.5 py-1 text-[10px] text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 cursor-pointer"
        >
          {inputExpanded ? (
        ...
        {inputExpanded && (
          <pre className="px-2.5 pb-2 text-[11px] text-gray-600 dark:text-gray-400 font-mono overflow-x-auto max-h-48 whitespace-pre-wrap">
      ...
      {execution.result && (
        <div className="px-2.5 py-1.5">
          <pre
            className={`text-[11px] font-mono overflow-x-auto max-h-48 whitespace-pre-wrap ${
      ...
      {execution.progress && execution.status === 'running' && (
        <div className="px-2.5 py-1 text-[10px] text-gray-500 dark:text-gray-400 border-t border-gray-200/30 dark:border-gray-700/30">
