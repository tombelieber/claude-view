  ...
  return (
    <div className="py-0.5 border-l-2 border-l-gray-400 pl-1 my-1" aria-label="Message queue event">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-xs font-mono text-gray-500 dark:text-gray-400">{messageText}</span>
        {queueId && (
      ...
      {content && content.length > 0 && (
        <div className="text-xs font-mono text-gray-400 dark:text-gray-500 ml-4 mt-0.5 truncate">
          {content}
        </div>
      )}
    </div>
