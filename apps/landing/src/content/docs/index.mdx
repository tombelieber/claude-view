...
- [Installation →](/docs/docs/installation/) — detailed setup, ports, and config
- [Mission Control →](/docs/docs/features/mission-control/) — real-time agent monitoring
- [MCP Integration →](/docs/docs/guides/mcp-integration/) — connect AI agents to claude-view
