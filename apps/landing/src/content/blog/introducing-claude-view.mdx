...
**MCP integration** — 8 read-only tools that let other AI agents query your session data. Ask Claude "what did I work on last week?" and get a real answer.
...
[Read the docs →](/docs/) · [GitHub →](https://github.com/anthropics/claude-view)
