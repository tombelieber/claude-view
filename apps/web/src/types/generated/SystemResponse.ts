 ...
 */
export type SystemResponse = { storage: StorageInfo, performance: PerformanceInfo, health: HealthInfo, integrity: IntegrityInfo, indexHistory: Array<IndexRunInfo>, classification: ClassificationInfo, claudeCli: ClaudeCliStatus, };
