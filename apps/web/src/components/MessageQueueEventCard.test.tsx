...
describe('MessageQueueEventCard', () => {
  describe('rendering', () => {
    it('should render enqueue operation with timestamp', () => {
      render(<MessageQueueEventCard operation="enqueue" timestamp="14:32:15" />)
    ...
    it('should render dequeue operation as "Message processed"', () => {
      render(<MessageQueueEventCard operation="dequeue" timestamp="14:32:15" />)
      expect(screen.getByText(/Message processed/)).toBeInTheDocument()
    })

    it('should show content preview when provided', () => {
      render(
        <MessageQueueEventCard operation="enqueue" timestamp="14:32:15" content="Hello world" />,
      )
    ...
    it('should show queueId when provided', () => {
      render(
        <MessageQueueEventCard operation="enqueue" timestamp="14:32:15" queueId="queue-abc-123" />,
      )
  ...
  describe('edge cases', () => {
    ...
    it('should render with empty content string', () => {
      const { container } = render(
        <MessageQueueEventCard operation="enqueue" timestamp="14:32:15" content="" />,
      )
      expect(container.firstElementChild).toBeInTheDocument()
    })

    it('should render without timestamp (no time shown)', () => {
      render(<MessageQueueEventCard operation="enqueue" timestamp="" />)
