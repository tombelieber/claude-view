...
export function StatsDashboard() {
  ...
  const {
    ...
    error,
    refetch,
  } = useDashboardStats(projectFilter, branchFilter, {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100">
                {projectFilter ? `${projectFilter} Usage` : 'Your Claude Code Usage'}
              </h1>
              {projectFilter && (
                <button
                  onClick={() => {
                  ...
                  {data.map((item) => (
                    ...
                    >
                      ...
                      <div className="h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                        <div
                          className={cn(
                            'h-full group-hover:bg-blue-500 transition-colors rounded-full',
                            color,
                          )}
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            {[
              {
                label: 'Edits',
                value: stats.toolTotals.edit + stats.toolTotals.write,
                icon: Pencil,
                color: 'text-blue-500',
              },
              ...
              <div
                key={label}
                className="text-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-800 rounded-lg"
              >
  ...
  return (
    <Tooltip.Provider delayDuration={0}>
      <div className="relative">
        ...
        <div className={cn('flex gap-1', isMobile && 'overflow-x-auto pb-2 -mx-1 px-1')}>
          ...
          >
            ...
            <div className="flex gap-0.5">
              ...
              <div
                className={cn(
                  isMobile ? 'w-4 h-4' : 'w-3 h-3',
                  'rounded-sm bg-green-200 dark:bg-green-600',
                )}
              />
              <div
                className={cn(
                  isMobile ? 'w-4 h-4' : 'w-3 h-3',
                  'rounded-sm bg-green-300 dark:bg-green-400',
                )}
              />
        ...
        {showScrollIndicator && (
          <p className="text-xs text-gray-400 mt-1 text-center">Swipe to see more weeks</p>
        )}
      </div>
    </Tooltip.Provider>
  )
