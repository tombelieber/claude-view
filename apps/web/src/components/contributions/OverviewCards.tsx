import { Activity, FileCode2, Target, TrendingDown, TrendingUp } from 'lucide-react'
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
        ...
        <div className="space-y-3">
          ...
          {fluency.trend !== null && <TrendBadge value={fluency.trend} label="vs last period" />}

          <InsightLineCompact
            insight={fluency.insight}
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
        ...
        <div className="space-y-3">
          <div>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-semibold text-gray-900 dark:text-gray-100 tabular-nums">
                {effectiveness.commitRate !== null
                  ? `${(effectiveness.commitRate * 100).toFixed(0)}%`
                  : '--'}
              </span>
