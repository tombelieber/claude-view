...
export function SessionSummaryCard({
  ...
  if (!summary || summary.trim().length === 0) {
    return (
      <div className="py-0.5 border-l-2 border-l-gray-400 pl-1 my-1" aria-label="Session summary">
  ...
  const displayText =
    expanded || !needsTruncation ? summary : summary.slice(0, TRUNCATE_LENGTH) + '...'
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[10px] text-gray-600 dark:text-gray-300">
            <span className="font-mono font-medium">Session summary:</span> {displayText}
          </div>
