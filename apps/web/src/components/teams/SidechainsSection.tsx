...
const DOT_BG: Record<string, string> = {
  blue: 'bg-blue-500', green: 'bg-green-500', yellow: 'bg-amber-500',
...
export function SidechainsSection({
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-px h-full mx-auto bg-gray-200 dark:bg-gray-800 group-hover:bg-indigo-500/40 group-active:bg-indigo-500/60 transition-colors" />
      </div>
      ...
      {[...byMember.entries()].map(([member, chains]) => {
        ...
        return (
          <div key={member} className="px-3 py-1.5 border-b border-gray-100 dark:border-gray-800/50 last:border-b-0">
            {/* Member header: colored dot + name */}
