...
export function PatternsTab({ groups }: PatternsTabProps) {
  const totalPatterns = groups.high.length + groups.medium.length + groups.observations.length
    ...
    <div>
      <div className="flex items-center justify-between pt-4 mb-4">
        <div className="flex items-center gap-3">
          <span className="text-sm text-gray-500 dark:text-gray-400">{totalPatterns} patterns</span>
