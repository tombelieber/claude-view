...
describe('HookSummaryCard', () => {
  ...
  describe('Happy path', () => {
    ...
    it('should show error count when hookErrors provided', () => {
      render(<HookSummaryCard {...defaultProps} hookErrors={['lint failed']} />)
    ...
    it('should show prevented continuation warning', () => {
      render(<HookSummaryCard {...defaultProps} preventedContinuation={true} />)
  ...
  describe('Collapsible behavior', () => {
    ...
    it('should show hook errors when expanded', () => {
      render(<HookSummaryCard {...defaultProps} hookErrors={['lint failed', 'test timeout']} />)
