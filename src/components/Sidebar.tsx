...
import { ChevronRight, Folder, FolderOpen, Clock, Home, GitBranch, AlertCircle, List, FolderTree, ChevronsUpDown, ChevronsDownUp, BarChart3, X, ArrowRight, Server, Lightbulb } from 'lucide-react'
