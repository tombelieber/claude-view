...
/**
 * AI Generation section skeleton loader.
 * Shows placeholder for the AI Code Generation breakdown section.
 */
export function AIGenerationSkeleton() {
  return (
    <div
      ...
      role="status"
      aria-busy="true"
      aria-label="Loading AI generation statistics"
    >
      <span className="sr-only">Loading AI generation statistics...</span>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          {[1, 2, 3].map(i => (
            ...
            >
              ...
              <div className="h-7 w-16 bg-gray-300 dark:bg-gray-600 rounded mb-2" />
...
/**
 * Storage overview section skeleton loader.
 * Shows placeholder for the Data & Storage settings section.
 */
export function StorageSkeleton() {
  return (
    <div
      ...
      role="status"
      aria-busy="true"
      aria-label="Loading storage statistics"
    >
      <span className="sr-only">Loading storage statistics...</span>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[1, 2, 3, 4, 5, 6].map(i => (
          ...
          >
            <div className="h-3 w-16 bg-gray-200 dark:bg-gray-700 rounded mx-auto mb-2" />
            <div className="h-5 w-12 bg-gray-300 dark:bg-gray-600 rounded mx-auto" />
          </div>
        ))}
      </div>
 ...
 * Shows placeholder for the entire settings page.
 */
              ...
              {[1, 2].map(item => (
                <div key={item} className="flex items-center justify-between py-2">
                  <div>
                    ...
                    <div className="h-3 w-56 bg-gray-50 dark:bg-gray-800/50 rounded" />
                  </div>
