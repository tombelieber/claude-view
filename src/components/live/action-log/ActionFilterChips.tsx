...
const CATEGORIES: { id: ActionCategory | 'all'; label: string; color: string }[] = [
  ...
  { id: 'hook_progress', label: 'Hook Progress', color: 'bg-yellow-500/10 text-yellow-400 border-yellow-500/30' },
  ...
  { id: 'context', label: 'Context', color: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' },
