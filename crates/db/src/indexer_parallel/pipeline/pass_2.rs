// crates/db/src/indexer_parallel/pipeline/pass_2.rs
// Legacy pass-2: parallel deep JSONL parsing for extended metadata + search indexing.

use claude_view_core::{ClassifyResult, Registry};
