...
impl Database {
    ...
    /// Query A: sessions table metrics (sessions, prompts, files_edited, reedited) × 2 periods
    /// Query B: tokens from turns table × 2 periods
    /// Query C: commits from session_commits × 2 periods
