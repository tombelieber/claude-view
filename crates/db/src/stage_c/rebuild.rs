    ...
    for row in &rows {
        ...
        let delta = StatsDelta {
            ...
            stats: SessionStats {
                ...
                first_message_at: row.try_get::<Option<String>, _>("first_message_at")?,
                last_message_at: row.try_get::<Option<String>, _>("last_message_at")?,
...
mod tests {
    ...
    async fn rebuild_populates_from_one_session_stats_row() {
        ...
        sqlx::query(
            r"INSERT INTO session_stats (
                ...
                100, 50,
                3, 120,
                '2026-04-19T10:00:00Z', '2026-04-19T14:30:00Z',
                'claude-opus-4-7', 'main', '-Users-test-proj',
                '/tmp/test.jsonl', 0, 1776055800
            )",
        )
        .execute(&pool)
        .await
    ...
    async fn rebuild_is_idempotent() {
        ...
        sqlx::query(
            ...
            ) VALUES ('s1', X'01', 0, 1, 1, 0, 500, '2026-04-19T14:00:00Z', 'p1')",
        )
        .execute(&pool)
        .await
        .unwrap();
