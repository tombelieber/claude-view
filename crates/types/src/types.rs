...
impl SessionInfo {
    ...
    pub fn tokens_per_prompt(&self) -> Option<f64> {
        ...
        Some((total_input + total_output) as f64 / self.user_prompt_count as f64)
    }

    /// A2.2 Re-edit Rate: reedited_files_count / files_edited_count
    pub fn reedit_rate(&self) -> Option<f64> {
        if self.files_edited_count == 0 {
            return None;
        }
        Some(self.reedited_files_count as f64 / self.files_edited_count as f64)
    }
    ...
    pub fn tool_density(&self) -> Option<f64> {
        ...
        Some(self.tool_call_count as f64 / self.api_call_count as f64)
    }
    ...
    pub fn edit_velocity(&self) -> Option<f64> {
        ...
        Some(self.files_edited_count as f64 / (self.duration_seconds as f64 / 60.0))
    }
    ...
    pub fn read_to_edit_ratio(&self) -> Option<f64> {
        ...
        Some(self.files_read_count as f64 / self.files_edited_count as f64)
    }
}
