...
use claude_view_core::discovery::{claude_projects_dirs, resolve_project_path_with_cwd};
...
pub fn collect_jsonl_files(
    ...
    let projects_dirs =
        claude_projects_dirs().map_err(|e| ApiError::Internal(format!("Projects dir: {e}")))?;
