...
pub fn is_plan_skill(skill: &str) -> bool {
    ...
    matches!(
        sl.as_str(),
        "plan" | "office-hours" | "brainstorm" | "plan-ceo-review" | "plan-eng-review"
        | "plan-design-review" | "design-consultation" | "autoplan"
...
pub fn is_review_skill(skill: &str) -> bool {
    let sl = skill.to_lowercase();
    sl.contains("review") || sl.contains("audit") || sl.contains("shippable") || sl.contains("prove-it")
}
...
pub fn is_ship_skill(skill: &str) -> bool {
    let sl = skill.to_lowercase();
    sl.contains("ship") || sl.contains("release") || sl.contains("deploy") || sl.contains("land-and")
}
